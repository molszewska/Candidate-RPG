...
export const DLG: Record<string, DlgNode> = {
  ...
  landon_root: { sp: 'LANDON', tx: "*phone in hand, grinning*\nApplicant! You made it!\nI've been waiting.\nSit. Or stand. But listen.",
    opts: [{ l: "Tips for the screening call?", n: 'landon_tips' }, { l: "What's sales like here?", n: 'landon_culture' }, { l: "[ leave ]", n: null }] },
  landon_tips: { sp: 'LANDON', tx: "Know your numbers cold:\nARR, quota attainment, pipeline velocity.\nWe can smell if you made them up.\nBe proud of your misses too.",
    opts: [{ l: "More →", n: 'landon_tips2' }, { l: "← Back", n: 'landon_root' }] },
  landon_tips2: { sp: 'LANDON', tx: "Biggest tip? Be curious about the product.\nNot just 'I read the homepage'.\nActually use it. Break something.\nCome back with a real question.",
    opts: [{ l: "← Back", n: 'landon_root' }] },
  landon_culture: { sp: 'LANDON', tx: "No SDR. No hand-holding. No deck.\nYou own the full cycle start to finish.\nIf that scares you, that's fine.\nIf it excites you — you're our person.",
    opts: [{ l: "← Back", n: 'landon_root' }] },

  tyler_root: { sp: 'TYLER', tx: "*leaning back, completely unbothered*\nYeah. Hi.\nYou're the candidate?\nOk. What do you need.",
    opts: [{ l: "Tips for the sales interview?", n: 'tyler_tips' }, { l: "What do you look for?", n: 'tyler_traits' }, { l: "[ leave ]", n: null }] },
  tyler_tips: { sp: 'TYLER', tx: "They'll run a roleplay scenario.\nDon't pitch at minute one.\nListen. Find the actual problem.\nThen show them PostHog solves it.",
    opts: [{ l: "More →", n: 'tyler_tips2' }, { l: "← Back", n: 'tyler_root' }] },
  tyler_tips2: { sp: 'TYLER', tx: "It's not about product knowledge.\nYou'll learn the product.\nIt's about: can you hold a room?\nCan you read when someone's not buying?",
    opts: [{ l: "← Back", n: 'tyler_root' }] },
  tyler_traits: { sp: 'TYLER', tx: "Curiosity. Coachability.\nSomeone who doesn't fold\nwhen a prospect pushes back.\nAnd someone who can just... close.",
    opts: [{ l: "← Back", n: 'tyler_root' }] },

  simon_root: { sp: 'SIMON', tx: "*has a spreadsheet open on both monitors*\nHey. Just updating pipeline.\nWant to talk GTM SuperDay?",
    opts: [{ l: "Yes, SuperDay tips please", n: 'simon_superday' }, { l: "What metrics matter?", n: 'simon_metrics' }, { l: "[ leave ]", n: null }] },
  simon_superday: { sp: 'SIMON', tx: "GTM SuperDay is collaborative.\nYou work through a real scenario\nwith the team. Treat it like the job,\nnot an audition.",
    opts: [{ l: "More →", n: 'simon_superday2' }, { l: "← Back", n: 'simon_root' }] },
  simon_superday2: { sp: 'SIMON', tx: "Come prepared. Know ICP, pricing,\nwhat 'product-led sales' means — for us.\nAsk us real questions.\nWe like it when you grill us back.",
    opts: [{ l: "← Back", n: 'simon_root' }] },
  simon_metrics: { sp: 'SIMON', tx: "ARR. ACV. Win rate. Time to close.\nChurn. NRR. Pipeline coverage.\n\nKnow which ones you moved and how.",
    opts: [{ l: "← Back", n: 'simon_root' }] },
  ...
  dana_root: { sp: 'DANA', tx: "*hangs up a call*\nSorry — customer escalation.\nAll good now. What's up?",
    opts: [{ l: "Tips for the CS interview?", n: 'dana_tips' }, { l: "What's CS like at PostHog?", n: 'dana_culture' }, { l: "How do I stand out?", n: 'dana_standout' }, { l: "[ leave ]", n: null }] },
  dana_tips: { sp: 'DANA', tx: "Bring a story about a customer\nyou actually turned around.\nNot just kept — turned around.\nMetrics help. Specifics help more.",
    opts: [{ l: "More →", n: 'dana_tips2' }, { l: "← Back", n: 'dana_root' }] },
  dana_tips2: { sp: 'DANA', tx: "We'll ask: how do you spot churn risk?\nHow do you escalate without\nmaking engineering hate you?\nThere's no script answer. We want yours.",
    opts: [{ l: "← Back", n: 'dana_root' }] },
  dana_culture: { sp: 'DANA', tx: "CS here isn't a ticket queue.\nIt's a strategic function.\nCustomers tell us more\nthan they tell each other.",
    opts: [{ l: "← Back", n: 'dana_root' }] },
  dana_standout: { sp: 'DANA', tx: "Sign up for PostHog. Free tier.\nActually use it. Break something.\nCome back with a real question about it.\nThat separates you from 90% of applicants.",
    opts: [{ l: "← Back", n: 'dana_root' }] },
