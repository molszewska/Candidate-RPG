...
export const DLG: Record<string, DlgNode> = {
  ...
  tim_lobby: { sp: 'TIM GLASER', img: '/pixel_tim.png', tx: "*points at the doors*\n\nEach room is a different team.\nTalk to people. Press SPACE.\n\nI'll be here.",
  ...
  tim_bg2: { sp: 'TIM GLASER', img: '/pixel_tim.png', tx: "James is the ambitious one.\nI just make sure things actually ship.",
    opts: [{ l: "← Back", n: 'tim_root' }] },
  tim_work: { sp: 'TIM GLASER', img: '/pixel_tim.png', tx: "Something that will break prod\nif I tell you.\n\nAsk me in a sprint.",
    opts: [{ l: "← Back", n: 'tim_root' }] },
  tim_james: { sp: 'TIM GLASER', img: '/pixel_tim.png', tx: "He pushes up the ambition. I set the pace.\n\nWe share a doc where we write our\nfeelings every week. Yes, really. It works.",
    opts: [{ l: "← Back", n: 'tim_root' }] },
