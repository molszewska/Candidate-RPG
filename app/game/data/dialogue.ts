...
export const DLG: Record<string, DlgNode> = {
  ...
  paul_eng_root: { sp: "PAUL D'AMBRA", tx: "*looks up from laptop*\nHey. You must be the applicant.\nWhat do you want to know?",
    opts: [{ l: "Tips for the exec round?", n: 'paul_exec_tips' }, { l: "What do you do here?", n: 'paul_eng_role' }] },
